...
final ScrollController _scrollHorizontalController =
ScrollController();

final ScrollController _jsonVerticalController =
ScrollController();

final ScrollController _jsonHorizontalController =
ScrollController();
...
final resultat =
ExcelImportService.convertirToutesLesLignes(
toutesLesLignes,
);
...
Future<void> _afficherResultatAnalyse(
ExcelImportResult resultat,
) async {
...
final jsonBrut = ExcelImportService.genererJson(
...
final version =
ExcelImportService.genererVersionProvisoire();

final versionJson =
ExcelImportService.genererVersionJson(
version,
);
...
Future<void> mesurerTaillePlanning() async {
  ...
  final int original =
  resultat['tailleOriginale'] as int;

  final int compresse =
  resultat['tailleCompressee'] as int;
...
content: Text(
'Planning envoyé à GitHub avec succès.',
),
),
);
} catch (e) {
